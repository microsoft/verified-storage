...
def arg_parser():
    ...
    parser.add_argument("--experiment_config", type=str, 
        help="path to the experiment config file to use", default="configs/experiment_config1.toml")
    parser.add_argument("--capybarakv_config", type=str, 
        help="path to the capybarakv config file to use", default="configs/capybarakv_config.toml")
