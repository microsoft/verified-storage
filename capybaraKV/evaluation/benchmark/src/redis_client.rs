use crate::kv_interface::{Key, KvInterface, ListElement, ListKvInterface, Value};
use crate::MicrobenchmarkConfig;
use core::marker::PhantomData;
use redis::{Client, Commands, Connection, FromRedisValue, RedisError, RedisResult};
    ...
    L: PmCopy,
{
    ...
    fn drop(&mut self) {
        self.server
            .kill()
            .expect("redis-server could not be killed");
