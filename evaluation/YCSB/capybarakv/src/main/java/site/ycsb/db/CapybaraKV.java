...
public class CapybaraKV {
  ...
  private static native long kvInit(byte[] capybarakvConfigFile, byte[] experimentConfigFile);
  ...
  public CapybaraKV(String capybarakvConfigFile, String experimentConfigFile) {
    ...
    kvPtr = CapybaraKV.kvInit(capybarakvConfigFileArray, experimentConfigFileArray);
  }
