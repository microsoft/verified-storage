...
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db capybarakv --experiment_config viper_test_config1.toml --workloads A
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db pmemrocksdb --experiment_config viper_test_config1.toml --workloads A
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db redis --experiment_config viper_test_config1.toml --workloads A
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config viper_test_config1.toml --workloads A

# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db capybarakv --experiment_config viper_test_config16.toml --workloads A
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db pmemrocksdb --experiment_config viper_test_config16.toml --workloads A
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db redis --experiment_config viper_test_config16.toml --workloads A
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config viper_test_config16.toml --workloads A

# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config viper_test_config2.toml --workloads A
