...
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db pmemrocksdb --experiment_config configs/experiment_config16.toml 
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db redis --experiment_config configs/experiment_config16.toml 
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config configs/experiment_config16.toml
