...
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config experiment_config_mem_storage.toml --workloads A
# # the capybarakv storage measurement experiment uses slightly less space than the regular-case experiments
# numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db capybarakv --experiment_config experiment_config_mem_storage.toml --capybarakv_config capybarakv_config_mem_storage.toml --workloads A
...
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config experiment_config1.toml
...
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config experiment_config16.toml
