...
# 1 thread
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db capybarakv --experiment_config configs/mini_experiment_config.toml --capybarakv_config configs/mini_capybarakv_config.toml --workloads A,X
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db pmemrocksdb --experiment_config configs/mini_experiment_config.toml --workloads A,X
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db redis --experiment_config configs/mini_experiment_config.toml --workloads A,X
numactl --membind 0 --cpunodebind 0 python3 run_ycsb.py --db viper --experiment_config configs/mini_experiment_config.toml --workloads A,X
