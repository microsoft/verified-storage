...
use crate::singlelog::singlelogimpl_v::UntrustedLogImpl;
...
verus! {
    ...
    // returned from singlelog operations. They're self-explanatory.
    #[is_variant]
    #[derive(Debug)]
    pub enum LogErr {
    ...
    /// A `LogImpl` wraps one `UntrustedLogImpl` and a
    ...
    /// `UntrustedLogImpl`.
    ///
    /// The `log_id` field is the singlelog ID. It's ghost.
    ///
    ...
    pub struct LogImpl<
        ...
        // D: Serializable
    > {
        untrusted_log_impl: UntrustedLogImpl<CDBRegion, HRegion, DRegion, H, D>,
        log_id: Ghost<u128>,
    }
    ...
    impl<
        ...
        // H: Serializable,
        // D: Serializable
    > TimestampedModule for LogImpl<CDBRegion, HRegion, DRegion, H, D> {
    ...
    impl<
        ...
        // H: Serializable,
        // D: Serializable
    > LogImpl<CDBRegion, HRegion, DRegion, H, D>  {
        ...
        // // singlelog ID to uniquely identify it. See `main.rs` for more
        // // documentation.
        // pub exec fn setup(pm_regions: &mut PMRegions) -> (result: Result<(Vec<u64>, u128), LogErr>)
        //     requires
        //         old(pm_regions).inv(),
        //     ensures
        //         pm_regions.inv(),
