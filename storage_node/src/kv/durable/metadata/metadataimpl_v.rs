...
verus! {
            ...
            K: PmCopy,
    {
        ...
        pub open spec fn insert(self, index: int, entry: MetadataTableViewEntry<K>) -> Self
        {
            Self{
                durable_metadata_table: self.durable_metadata_table.update(index, DurableEntry::Valid(entry))
            }
        }
            ...
            K: PmCopy + std::fmt::Debug,
    {
        ...
        pub exec fn get_validify_log_entry(
            ...
            requires 
                ...
                self@.durable_metadata_table[index as int] is Invalid,
            ...
            proof {
                ...
                assert forall |i: nat| #![trigger extract_bytes(new_main_table_region,
                    ...
                    &&& i == index ==>
                           ...
                           DurableEntry::<MetadataTableViewEntry<K>>::Valid(entry)
                ...
                let old_entries =
                    parse_metadata_entries::<K>(old_main_table_region, overall_metadata.num_keys as nat,
                                                overall_metadata.metadata_node_size as nat);
                assert(old_entries[index as int] is Invalid);
                ...
                self.pending_deallocations_view().is_empty(),
    {
...

        {
            ...
            proof {
                assert forall |i| 0 <= i < self@.durable_metadata_table.len() implies
                    self.outstanding_cdb_write_matches_pm_view(subregion_view, i, overall_metadata.metadata_node_size)
                by { lemma_valid_entry_index(i as nat, overall_metadata.num_keys as nat, overall_metadata.metadata_node_size as nat); }
