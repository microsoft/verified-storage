        ...
        I: PmCopy + Sized + std::fmt::Debug,
{
            ...
            }
    {
        ...
        proof {
            ...
            let all_addrs = Set::new(|addr: u64| sm.table.validate_row_addr(addr));
            assert(free_list@.to_set() + item_addrs@ == all_addrs);
            assert(free_list@.to_set() + item_table_snapshot.m.dom() == all_addrs);
        }
