...
impl PersistentMemorySubregion
{
    ...
    //             relative_addr + S::spec_size_of(),
    //         );
    //         let true_val = S::spec_from_bytes(true_bytes);
    //         if pm.constants().impervious_to_corruption {
    //             output == true_val
    //         } else {
    //             maybe_corrupted(*output, true_val, relative_addr + self.start())
    //         }
    //     })
    // {
    //     let absolute_addr = relative_addr + self.start_;
    //     let ghost num_bytes = S::spec_size_of();
    //     let ghost true_bytes1 = self.view(pm).committed().subrange(
    //         relative_addr as int,
    ...
    //             output == true_val
    //         } else {
    //             maybe_corrupted(*output, true_val, absolute_addr as int)
    //         }
    //     })
    // {
    //     let ghost num_bytes = S::spec_size_of();
